            ...
            <div className='w-full max-w-4xl h-full p-5 flex-col gap-5 flex'>
                ...
                <Card className='flex flex-col gap-3'>
                    ...
                    <div className='flex gap-3 items-center'>
                        <label className='min-w-[72px]'>Name:</label>
                        <input
                            type='text'
                            value={name}
                            ...
                            className='px-2 border-0 py-1 rounded flex-1 aria-[invalid=true]:border aria-[invalid=true]:border-red-500 aria-[invalid=true]:ring-red-500'
                        />
                        {editName ? (
                            <>
                                <button
